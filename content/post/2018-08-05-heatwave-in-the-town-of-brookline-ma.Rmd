...
```{r, echo=FALSE, fig.cap="Populations with MOE as percentage of estimate"}
library(mapview)
library(sf)
...
vulns_geo <- dplyr::left_join(vulnerabilities, p)
